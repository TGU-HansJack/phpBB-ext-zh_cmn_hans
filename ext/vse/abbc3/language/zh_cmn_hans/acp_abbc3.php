...
$lang = array_merge($lang, array(
	...
	'ABBC3_GOOGLE_FONTS_NOTE'	=> '要使用此功能，必须在"加载设置"下启用"允许使用第三方内容分发网络"。',
	'ABBC3_INVALID_FONT'		=> '“%s”的字体名称无效',
	...
	'ABBC3_AUTO_VIDEO_EXPLAIN'	=> '该插件将纯文本视频文件URL转换为可播放的视频。仅转换以<samp class="error">http://</samp>或<samp class="error">https://</samp>开头并以<samp class="error">.mp4</samp>、<samp class="error">.ogg</samp>或<samp class="error">.webm</samp>结尾的URL。',
	'ABBC3_BBVIDEO'				=> 'BB视频',
	'ABBC3_BBVIDEO_EXPLAIN'		=> '安装可选的phpBB媒体嵌入扩展以访问嵌入式富媒体内容的设置和管理选项。',
	'ABBC3_MEDIA_EMBED_INSTALL'	=> [
		0	=> 'phpBB媒体嵌入扩展未安装。<a href="https://www.phpbb.com/customise/db/extension/mediaembed/" target="_blank">下载<i class="icon fa-external-link fa-fw" aria-hidden="true"></i></a>。',
		1	=> 'phpBB媒体嵌入扩展已安装。设置可在"发帖"选项卡下访问。'
	],
	'PNG' => 'PNG',
	'SVG' => 'SVG',
));